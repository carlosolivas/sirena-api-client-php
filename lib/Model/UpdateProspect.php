...
/**
 * UpdateProspect Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateProspect implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateProspect';
     ...
     * Sets phone
     *
     * @param string $phone Phone to add to the prospect
     *
     * @return $this
     */
     ...
     * Sets email
     *
     * @param string $email Email to add to the prospect
     *
     * @return $this
     */
     ...
     * Sets label
     *
     * @param string $label Change Label of the prospect
     *
     * @return $this
     */
