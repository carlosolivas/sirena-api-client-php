...
class Defaults implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['distance']) && !in_array($this->container['distance'], $allowedValues, true)) {
     ...
     * Sets currency
     *
     * @param string $currency Case-insensitive [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) currency code.
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getDistanceAllowableValues();
        if (!in_array($distance, $allowedValues, true)) {
