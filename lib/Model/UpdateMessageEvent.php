...
/**
 * UpdateMessageEvent Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateMessageEvent implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateMessageEvent';
     ...
     * Sets status
     *
     * @param string $status Status of the message (pending, sent, received, read, failed, deleted)
     *
     * @return $this
     */
